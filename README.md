...
This repository contains all the projects completed during the **CODTECH Data Analytics Internship**.  
The projects focus on applying data analytics concepts to real-world datasets, covering data preprocessing, analysis, modeling, and visualization.
